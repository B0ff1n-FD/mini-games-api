...
export class GoogleStrategy extends PassportStrategy(Strategy, 'google') {
  constructor(private readonly configService: ConfigService) {
    super({
      clientID: configService.get('GOOGLE_CLIENT_ID', null), // get the ID from Google Cloud Console
      clientSecret: configService.get('GOOGLE_SECRET', null), // get the SECRET from Google Cloud Console
      callbackURL: configService.get('GOOGLE_CALLBACK_URL', null),
      scope: ['email', 'profile'],
    });
  }
