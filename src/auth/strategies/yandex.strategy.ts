...
export class YandexStrategy extends PassportStrategy(Strategy, 'yandex') {
  constructor(private readonly configService: ConfigService) {
    super({
      clientID: configService.get('YANDEX_CLIENT_ID', null),
      clientSecret: configService.get('YANDEX_CLIENT_SECRET', null),
      callbackURL: configService.get('YANDEX_CALLBACK_URL', null),
    });
  }
