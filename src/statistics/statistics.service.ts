...
import { StatsQueryDoubleDto, StatsQueryOneDto } from './dto';
...
export class StatisticsService {
  ...
  async userStatsByField(userId: string, { productId, field, sortOrder, limit }: StatsQueryOneDto) {
    return await this.prisma.stats.findMany({
      take: limit,
  ...
  async userStatsByFields(userId: string, queryParams: StatsQueryDoubleDto) {
