...
import { ValidateId, ValidatePayloadExists, ValidateQueryFields } from '@common/validations';
...
export class StatisticsController {
  ...
  public async statsByProduct(@Param('productId', ValidateId) productId: string) {
  ...
  async productStatsByField(
    @Param('productId', ValidateId) productId: string,
    @Query(ValidateQueryFields) queryParams: StatsQueryOneDto,
  ) {
  ...
  async productStatsByFields(
    @Param('productId', ValidateId) productId: string,
    @Query(ValidateQueryFields) queryParams: StatsQueryDoubleDto,
  ) {
  ...
  @ErrorResponse('Products')
  @Get('users/:userId')
  public async statsByUser(@Param('userId', ValidateId) userId: string) {
